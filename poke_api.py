...
def download_pokemon_artwork(pokemon_name, folder_path='.')
    ...
    if poke_info is None:
        return
    #Extract the wrtwork URL from the info dictionary
    artwork_url = poke_info['sprites']['other']['official_artwork']['front-default']
    if artwork_url is None:
        print(f"No artwork available for (pokemon_name.capatalize()).")
        return
    ...
    print(f'(Downloading artwork for {pokemon_name.capatalize()})')  
